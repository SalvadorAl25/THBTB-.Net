<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Baterias.aspx.vb" Inherits="Baterias" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
	<br />
	<h3><asp:Label ID="lblBaterias" runat="server" Text=""></asp:Label></h3>
    <hr />

    <asp:DataList ID="DataList1" runat="server" DataKeyField="ID_PRODUCTO" DataSourceID="SqlDataSourceDrumm" CssClass="col-12">
        <ItemTemplate>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSourceDrumm" ConnectionString='<%$ ConnectionStrings:TheHardestBottonToBottonBD %>' SelectCommand="SELECT * FROM [PROD] WHERE ([CATEGORIA] LIKE '%' + @CATEGORIA + '%') ORDER BY [ID_PRODUCTO] DESC">
        <SelectParameters>
            <asp:SessionParameter SessionField="Baterias" Name="CATEGORIA" Type="String"></asp:SessionParameter>
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
