<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Guitarras.aspx.vb" Inherits="Guitarras" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
	<br />
	<h3><asp:Label ID="lblGuitarras" runat="server" Text=""></asp:Label></h3>
    <hr />

    <asp:DataList ID="DataList1" runat="server" DataKeyField="ID_PRODUCTO" DataSourceID="SqlDataSourceGuitarras">
        <ItemTemplate>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSourceGuitarras" ConnectionString='<%$ ConnectionStrings:TheHardestBottonToBottonBD %>' SelectCommand="SELECT * FROM [PROD] WHERE ([CATEGORIA] LIKE '%' + @CATEGORIA + '%') ORDER BY [ID_PRODUCTO]">
        <SelectParameters>
            <asp:SessionParameter SessionField="Guitarras" Name="CATEGORIA" Type="String"></asp:SessionParameter>
        </SelectParameters>
    </asp:SqlDataSource>
